...
{
    internal class TableApiClientHandler : DelegatingHandler
    {
        private readonly IHttpRequestHandler _httpRequestHandler;
        private readonly string _baseUrlDebug;
        private Uri _baseAddress;

        public TableApiClientHandler(IHttpRequestHandler httpRequestHandler, string baseUrlDebug) : base(new HttpClientHandler() { AutomaticDecompression = DecompressionMethods.GZip })
        {
