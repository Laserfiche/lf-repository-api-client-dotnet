...
namespace Laserfiche.SiteApiRepository.Client.V2
{
    ...
    public partial interface ISiteApiRepositoryClient
    {
        ...
        /// <returns>Document creation is successful.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SwaggerResponse<SimpleImportResult>> Simple_ImportAsync(string repoId, int parentEntryId, FileParameter file = null, SimpleImportRequest request = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <param name="repoId">The requested repository id.</param>
        /// <param name="entryId">The id of entry to export.</param>
        /// <param name="part">Specifies which 'part' of the document to export. Options include: Edoc, Pages and Text.</param>
        /// <param name="format">Specifies the format to export as. This value is ignored when part=Edoc or Text. Options include: Tiff, PNG, PDF and JPEG.</param>
        /// <param name="pageRange">A comma seperated range of pages to include. This value is ignored when part=Edoc. Ex: 1,3,4 or 1-3,5-7,9.</param>
        /// <param name="auditEvent">The audit event to associate with the export operation.</param>
        /// <returns>Export successfully.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SwaggerResponse<ODataValueOfString>> Simple_ExportAsync(string repoId, int entryId, Part part, Format? format = null, string pageRange = null, AuditEvent auditEvent = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class SiteApiRepositoryClient : ISiteApiRepositoryClient
    {
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<ODataValueOfListOfAttribute>> Get_trustee_attribute_key_value_pairsAsync(string repoId, bool? everyone = null, string select = null, string orderby = null, bool? count = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Attributes?");
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Attributes/{attributeKey}?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<WFieldInfo>> Get_Field_Definition_by_IDAsync(string repoId, int fieldDefinitionId, string culture = null, string select = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/FieldDefinitions/{fieldDefinitionId}?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/FieldDefinitions?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            if (culture != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("culture") + "=").Append(System.Uri.EscapeDataString(ConvertToString(culture, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
        ...
        /// <returns>Document creation is successful.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<SwaggerResponse<SimpleImportResult>> Simple_ImportAsync(string repoId, int parentEntryId, FileParameter file = null, SimpleImportRequest request = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (parentEntryId == null)
                throw new System.ArgumentNullException("parentEntryId");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Entries/{parentEntryId}/Import");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 201)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<SimpleImportResult>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                            return new SwaggerResponse<SimpleImportResult>(status_, headers_, objectResponse_.Object);
                        }
                        else
                        if (status_ == 403)
                        {
                        ...
                        if (status_ == 409)
                        {
                            ...
                            throw new ApiException<SimpleImportResult>("Document creation is partially successful.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 500)
                        {
                            ...
                            throw new ApiException<ProblemDetails>("Document creation is completely failed.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 400)
                        {
                            ...
                            throw new ApiException<ProblemDetails>("Invalid request. Required property might be missing.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 401)
                        {
        ...
        /// <returns>Export successfully.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<SwaggerResponse<ODataValueOfString>> Simple_ExportAsync(string repoId, int entryId, Part part, Format? format = null, string pageRange = null, AuditEvent auditEvent = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (entryId == null)
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Entries/{entryId}/Export?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            urlBuilder_.Append(System.Uri.EscapeDataString("part") + "=").Append(System.Uri.EscapeDataString(ConvertToString(part, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            if (format != null)
            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var content_ = new System.Net.Http.StringContent(Newtonsoft.Json.JsonConvert.SerializeObject(auditEvent, _settings.Value));
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ODataValueOfString>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                            return new SwaggerResponse<ODataValueOfString>(status_, headers_, objectResponse_.Object);
                        }
                        else
                        if (status_ == 400)
                        {
                        ...
                        if (status_ == 500)
                        {
                            ...
                            throw new ApiException<ProblemDetails>("Export operation failed due to an internal server error.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<Entry>> Get_EntryAsync(string repoId, int entryId, string select = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Entries/{entryId}?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{entryId}", System.Uri.EscapeDataString(ConvertToString(entryId, System.Globalization.CultureInfo.InvariantCulture)));
            if (select != null)
            {
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<ODataValueOfIListOfEntry>> Get_Entry_ListingAsync(string repoId, int entryId, bool? groupByEntryType = null, string prefer = null, string select = null, string orderby = null, int? top = null, int? skip = null, bool? count = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Entries/{entryId}/Laserfiche.Repository.Folder/children?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{entryId}", System.Uri.EscapeDataString(ConvertToString(entryId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<ODataValueOfIListOfFieldValue>> Get_Field_ValuesAsync(string repoId, int entryId, string prefer = null, bool? formatValue = null, string culture = null, string select = null, string orderby = null, int? top = null, int? skip = null, bool? count = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Entries/{entryId}/fields?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{entryId}", System.Uri.EscapeDataString(ConvertToString(entryId, System.Globalization.CultureInfo.InvariantCulture)));
            if (formatValue != null)
            {
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<ODataValueOfIListOfWTagInfo>> Get_Tags_Assigned_to_EntryAsync(string repoId, int entryId, string prefer = null, string select = null, string orderby = null, int? top = null, int? skip = null, bool? count = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Entries/{entryId}/tags?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{entryId}", System.Uri.EscapeDataString(ConvertToString(entryId, System.Globalization.CultureInfo.InvariantCulture)));
            if (select != null)
            {
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<ODataValueOfIListOfWEntryLinkInfo>> Assign_Entry_LinksAsync(string repoId, int entryId, System.Collections.Generic.IEnumerable<PutLinksRequest> linksToAdd = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Entries/{entryId}/links");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{entryId}", System.Uri.EscapeDataString(ConvertToString(entryId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<AcceptedOperation>> Copy_entry_asyncAsync(string repoId, int entryId, CopyAsyncRequest request = null, bool? autoRename = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Entries/{entryId}/Laserfiche.Repository.Folder/CopyAsync?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{entryId}", System.Uri.EscapeDataString(ConvertToString(entryId, System.Globalization.CultureInfo.InvariantCulture)));
            if (autoRename != null)
            {
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<bool>> Delete_documentAsync(string repoId, int entryId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Entries/{entryId}/Laserfiche.Repository.Document/edoc");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{entryId}", System.Uri.EscapeDataString(ConvertToString(entryId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<bool>> Delete_pagesAsync(string repoId, int entryId, string pageRange = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Entries/{entryId}/Laserfiche.Repository.Document/pages?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{entryId}", System.Uri.EscapeDataString(ConvertToString(entryId, System.Globalization.CultureInfo.InvariantCulture)));
            if (pageRange != null)
            {
        ...
        public async System.Threading.Tasks.Task<FileResponse> Export_document_with_audit_reasonAsync(string repoId, int entryId, GetEdocWithAuditReasonRequest request = null, string range = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Entries/{entryId}/Laserfiche.Repository.Document/GetEdocWithAuditReason");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{entryId}", System.Uri.EscapeDataString(ConvertToString(entryId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<System.Collections.Generic.IDictionary<string, System.Collections.Generic.ICollection<string>>>> Get_dynamic_field_valuesAsync(string repoId, int entryId, GetDynamicFieldLogicValueRequest request = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Entries/{entryId}/fields/GetDynamicFieldLogicValue");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{entryId}", System.Uri.EscapeDataString(ConvertToString(entryId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<Entry>> Delete_assigned_templateAsync(string repoId, int entryId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Entries/{entryId}/template");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{entryId}", System.Uri.EscapeDataString(ConvertToString(entryId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/ServerSession/Invalidate");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/ServerSession/Refresh");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/ServerSession/Create");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Tasks/{operationToken}");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/AuditReasons");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Searches");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Searches/{searchToken}");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Searches/{searchToken}/Results?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{searchToken}", System.Uri.EscapeDataString(ConvertToString(searchToken, System.Globalization.CultureInfo.InvariantCulture)));
            if (groupByEntryType != null)
            {
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<ODataValueOfIListOfContextHit>> Get_Search_Context_HitsAsync(string repoId, string searchToken, int rowNumber, string prefer = null, string select = null, string orderby = null, int? top = null, int? skip = null, bool? count = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/Searches/{searchToken}/Results/{rowNumber}/ContextHits?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{searchToken}", System.Uri.EscapeDataString(ConvertToString(searchToken, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/SimpleSearches");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/TagDefinitions?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            if (culture != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("culture") + "=").Append(System.Uri.EscapeDataString(ConvertToString(culture, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<WTagInfo>> Get_Tag_Definition_by_IDAsync(string repoId, int tagId, string culture = null, string select = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/TagDefinitions/{tagId}?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/TemplateDefinitions?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<WTemplateInfo>> Get_Template_Definition_by_IDAsync(string repoId, int templateId, string culture = null, string select = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/TemplateDefinitions/{templateId}?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<ODataValueOfIListOfTemplateFieldInfo>> Get_Template_Field_DefinitionsAsync(string repoId, int templateId, string prefer = null, string culture = null, string select = null, string orderby = null, int? top = null, int? skip = null, bool? count = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/TemplateDefinitions/{templateId}/fields?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{templateId}", System.Uri.EscapeDataString(ConvertToString(templateId, System.Globalization.CultureInfo.InvariantCulture)));
            if (culture != null)
            {
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v2-alpha/Repositories/{repoId}/TemplateDefinitions/Fields?");
            urlBuilder_.Replace("{repoId}", System.Uri.EscapeDataString(ConvertToString(repoId, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class SimpleImportResult
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class SimpleImportRequest
    {
        [Newtonsoft.Json.JsonProperty("name", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Name { get; set; }
        ...
        public SimpleImportMetadata Metadata { get; set; }
