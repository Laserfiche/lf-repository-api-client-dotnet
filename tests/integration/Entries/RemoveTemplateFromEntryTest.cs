...
{
    [TestClass]
    public class RemoveTemplateFromEntryTest : BaseTest_V1
    {
        ...
        public async Task RemoveTemplateFromEntry_ReturnEntry()
        {
            ...
            var setTemplateEntryResponse = await client.WriteTemplateValueToEntryAsync(TestConfig.RepositoryId, entry.Id, request);
            ...
            var deleteTemplateResponse = await client.DeleteAssignedTemplateAsync(TestConfig.RepositoryId, entry.Id);
