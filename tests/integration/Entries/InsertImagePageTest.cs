...
{
    [TestClass]
    public class InsertImagePageTest : BaseTest
    {
        int createdEntryId;
        ...
        public async Task InsertImagePage()
        {
            ...
            var result = await client.EntriesClient.InsertImagePageAsync(new InsertImagePageParameters()
            {
            ...
            Assert.IsTrue(pageInfo.HasImage, "Inserted page should have image content");
        }
    }
}
