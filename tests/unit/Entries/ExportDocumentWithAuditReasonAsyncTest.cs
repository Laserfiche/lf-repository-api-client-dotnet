...
{
    public class ExportDocumentWithAuditReasonAsyncTest
    {
        ...
        [Fact]
        public async Task ExportDocumentWithAuditReasonAsync_200()
        {
            // ARRANGE
            ...
            using (var stream = new MemoryStream())
            {
                ...
                {
                    _ = new FileResponse(200, null, stream, null, null);
                    ...
                    var expectedUri = new Uri(baseAddress + $"v1/Repositories/{repoId}/Entries/{entryId}/Laserfiche.Repository.Document/GetEdocWithAuditReason");
                    ...
                    handlerMock.Protected().Verify(
                       ...
                       ItExpr.Is<HttpRequestMessage>(req =>
                          ...
                          && req.Content.ToString() == new StringContent(JsonConvert.SerializeObject(new GetEdocWithAuditReasonRequest()
                          {
                              AuditReasonId = 1,
                              Comment = "asdf"
                          })).ToString()
        ...
        [Fact]
        public async Task ExportDocumentWithAuditReasonAsync_206()
        {
            // ARRANGE
            string baseAddress = "http://api.laserfiche.com/";
            string repoId = "repoId";
        ...
        [Fact]
        public async Task ExportDocumentWithAuditReasonAsync_AnyOther()
        {
            // ARRANGE
            string baseAddress = "http://api.laserfiche.com/";
            string repoId = "repoId";
