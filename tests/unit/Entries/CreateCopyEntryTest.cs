...
namespace Laserfiche.Repository.Api.Client.Test.Entries
{
    public class CreateCopyEntryTest
    {
        ...
        public async Task CreateOrCopyEntryAsync_ReturnSuccessfulStatusCode()
        {
            ...
            // ACT
            var response = await client.CreateOrCopyEntryAsync(repoId, (int)entry.ParentId, request);
        ...
        public async Task CreateOrCopyEntryAsync_ReturnErrorStatusCode()
        {
            ...
            // ACT
            var response = await Assert.ThrowsAsync<ApiException>(async () => await client.CreateOrCopyEntryAsync(repoId, entryId, request));
        ...
        public async Task CreateOrCopyEntryAsync_WithQueryParameters_ReturnSuccessfulStatusCode()
        {
            ...
            // ACT
            var response = await client.CreateOrCopyEntryAsync(repoId, (int)entry.ParentId, request, autoRename: true);
            var result = response.Result;
