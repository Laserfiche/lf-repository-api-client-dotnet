...
namespace Laserfiche.Repository.Api.Client.Test.FieldDefinitions
{
    public class FieldDefinitionsByIdTest
    {
        ...
        public async Task GetFieldDefinitionByIdAsync_AnyOther()
        {
            ...
            // ACT
            await Assert.ThrowsAsync<ApiException>(async () => await client.FieldDefinitionsClient.GetFieldDefinitionByIdAsync(repoId, fieldDefinitionId: id).ConfigureAwait(false));
