...
namespace Laserfiche.Repository.Api.Client.Test.TagDefinitions
{
    public class TagDefinitionTest
    {
        ...
        { 
            ...
            // ACT
            var swaggerResponse = await client.GetTagDefinitionByIdAsync(repoId, tagInfo.Id);
        ...
        { 
            ...
            // ACT
            await Assert.ThrowsAsync<ApiException>(async () => await client.GetTagDefinitionByIdAsync(repoId, tagDefinition));
        ...
        { 
            ...
            // ACT
            var result = await client.GetTagDefinitionsAsync(repoId);
        ...
        public async Task GetTagDefinitionsAsync_AnyOther()
        {
            ...
            // ACT
            await Assert.ThrowsAsync<ApiException>(async () => await client.GetTagDefinitionsAsync(repoId));
        ...
        public async Task GetTagDefinitionsAsync_ODataQueryOptions()
        {
            ...
            // ACT
            _ = await client.GetTagDefinitionsAsync(repoId, prefer:"Prefer", select:"select", orderby:"orderBy",top:1, skip:1, count:true);
