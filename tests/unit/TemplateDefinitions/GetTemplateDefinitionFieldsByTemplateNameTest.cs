...
namespace Laserfiche.Repository.Api.Client.Test.TemplateDefinitions
{
    public class GetTemplateDefinitionFieldsByTemplateNameTest
    {
        ...
        public async Task GetTemplateFieldDefinitionsByTemplateNameAsync_ReturnSuccessfulStatusCode()
        {
            ...
            string templateDefinitioName = "Template";
            ...
            var expectedUri = new Uri(baseAddress + $"v1/Repositories/{repoId}/TemplateDefinitions/Fields?templateName={templateDefinitioName}");
        ...
        [Fact]
        public async Task GetTemplateFieldDefinitionsByTemplateNameAsync_ReturnErrorStatusCode()
        {
            // ARRANGE
            string baseAddress = "http://api.laserfiche.com/";
            string repoId = "repoId";
            ...
            // ACT
            var response = await Assert.ThrowsAsync<ApiException>(async () => await client.TemplateDefinitionsClient.GetTemplateFieldDefinitionsByTemplateNameAsync(repoId, templateDefinitioName).ConfigureAwait(false));
        ...
        [Fact]
        public async Task GetTemplateFieldDefinitionsByTemplateNameAsync_WithPreferHeader_WithQueryParameters_ReturnSuccessfulStatusCode()
        {
            // ARRANGE
            string baseAddress = "http://api.laserfiche.com/";
            string repoId = "repoId";
